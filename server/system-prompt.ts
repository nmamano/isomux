...
APPEND a fact (the safe default - the server stamps the author and date; a normalized-exact duplicate is rejected with 409, and a line that would put the scope over its size cap is rejected with 422 - trim first):
