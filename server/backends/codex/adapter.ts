...
Alternative: add \`OPENAI_API_KEY\` under User Settings → Connections, then \`/clear\`. If you set a custom \`CODEX_HOME\` there, prefix the login command above with \`CODEX_HOME=<your value>\` first.`;
