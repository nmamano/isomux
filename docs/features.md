...
- **Codex ships bundled** - no separate install. Connect a ChatGPT account from User Settings, or use the terminal fallback. The unattended VPS installer includes the Claude Code CLI; source checkouts still install it separately.
