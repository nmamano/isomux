...
- **Bundled skills** like `/isomux-grill-me` (based on the original `/grill-me` by Matt Pocock), `/isomux-peer-review`, `/isomux-pair-programming`, `/isomux-subagent-review`, `/isomux-report-bug` — available to every agent out of the box
