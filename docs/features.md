...
- **Agents use your browser** — Agents can read pages, navigate, and fill forms. Scoped reads reach individual feed entries and frames; snapshots include editable composer text.
