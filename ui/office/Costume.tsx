    ...
    <g transform={`translate(26 ${y})`} data-costume-body={costume}>
      ...
      <g clipPath={`url(#${clipId})`}>
        {costume === "doctor" && (
          <>
            <path
              d="M-5 -3 L0 3 L5 -3 M0 3 V10"
              fill="none"
              stroke="#a6bec4"
              strokeWidth="1.5"
            />
            <path
              d="M-6 -2 V3 Q-6 7 -3 7 Q0 7 0 3 V-2"
              fill="none"
              stroke="#294653"
              strokeWidth="1.6"
            />
        ...
        {costume === "chef" && (
          <>
            ...
            {[2, 6, 10].map((y) => (
              <g key={y}>
                <circle cx="-3" cy={y} r="1" fill="#354451" />
                <circle cx="3" cy={y} r="1" fill="#354451" />
              </g>
            ))}
          </>
  ...
  return (
    <g transform={`translate(${headCx} ${headCy})`} data-costume-head={costume}>
      ...
      {(costume === "firefighter" || costume === "construction") && (
        <>
          <path
            d="M-11 -8 Q-11 -21 0 -21 Q11 -21 11 -8 Z"
            fill={costume === "firefighter" ? "#d84536" : "#f3c52e"}
          />
          <path
            d="M-13 -8 H13 M0 -19 V-10"
            stroke={costume === "firefighter" ? "#9c2d29" : "#bb8b20"}
            strokeWidth="3"
            strokeLinecap="round"
          />
          {costume === "firefighter" && (
            <path d="M-3 -15 H3 V-11 L0 -9 L-3 -11 Z" fill="#f9df7d" />
          )}
        </>
      )}
      {costume === "chef" && (
        <>
          <path
            d="M-8 -8 V-16 Q-15 -17 -11 -23 Q-7 -28 -3 -24 Q0 -30 5 -25 Q12 -28 13 -21 Q14 -16 8 -15 V-8 Z"
            fill="#fafbf9"
            stroke="#c2cdd3"
            strokeWidth="1"
          />
