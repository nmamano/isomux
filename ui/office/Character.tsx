...
function Hair({
  ...
  const cap =
    "M-10 0 Q-12 -10 -3 -11 Q7 -14 10 -5 L10 0 L8 -3 Q4 -3 2 -7 Q-2 -2 -8 -3 Z";
    ...
    case "curly":
      shape = (
        <>
          ...
          <path
            d="M-9 -8 Q-6 -11 -4 -8 M0 -9 Q3 -12 5 -8 M8 -6 Q11 -6 10 -3"
            fill="none"
            stroke="white"
            strokeOpacity=".15"
          />
  ...
  return (
    <g
      transform={`translate(${headCx} ${headCy})`}
      fill={color}
      strokeLinecap="round"
      strokeWidth=".8"
    >
...
function Hat({
  ...
  switch (type) {
    case "cap":
      shape = (
        <>
          ...
          />
          <path
            d="M-11 -6 Q0 -7 11 -6 L13 -4 Q4 -1 -14 -3 Q-17 -4 -14 -5 Z"
            fill={color}
          />
          <path
            d="M-14 -4 Q0 -2 12 -4"
    ...
    case "beanie":
      shape = (
        <>
          ...
          <path
            d="M-5 -14 L-6 -8 M0 -15 V-8 M5 -14 L6 -8"
            stroke="white"
            strokeOpacity=".16"
          />
          <path d="M-11 -8 Q0 -6 11 -8 V-3 Q0 -1 -11 -3 Z" fill={color} />
          <path
            d="M-11 -8 Q0 -6 11 -8 M-10 -3 Q0 -1 10 -3"
            fill="none"
            stroke="black"
            strokeOpacity=".18"
          />
    ...
    case "bow":
      shape = (
        <g transform="translate(3 -11) rotate(12)">
          <path
            d="M0 0 Q-7 -6 -7 -3 L-7 3 Q-6 5 0 1 Q7 5 7 3 V-3 Q6 -5 0 0 Z"
            fill="#df7596"
          />
    ...
    case "headband":
      shape = (
        <>
          <path
            d="M-10 -1 Q-11 -11 0 -11 Q11 -11 10 -1"
            stroke="#cf743e"
            strokeWidth="2.5"
            fill="none"
          />
          <path
            d="M-8 -6 Q-6 -10 0 -10 Q5 -10 8 -6"
            stroke="#ffc68b"
            strokeWidth=".8"
            fill="none"
          />
  ...
  switch (type) {
    case "stubble":
      shape = (
        <>
          <path
            d="M-8 4 Q-6 10 0 10 Q6 10 8 4 L5 5 Q0 9 -5 5 Z"
            opacity=".22"
          />
          <g opacity=".65">
            {[
    ...
    case "mustache":
      shape = (
        <path d="M0 5 Q-2 3 -4 5 Q-5 6 -7 6 Q-6 9 -2 7 L0 6 L2 7 Q6 9 7 6 Q5 6 4 5 Q2 3 0 5 Z" />
      );
      break;
    default:
      return null;
...
function Accessory({
  ...
  switch (type) {
    case "glasses":
      shape = (
        <g fill="none" stroke="#40505d" strokeWidth="1">
    ...
    case "headphones":
      shape = (
        <>
          <path
            d="M-12 0 V-4 Q-12 -14 0 -14 Q12 -14 12 -4 V0"
            fill="none"
            stroke="#35404d"
            strokeWidth="3"
          />
    ...
    case "bow_tie":
      shape = (
        <g transform="translate(0 13)">
          <path
            d="M-1 0 L-5 -2.5 Q-6 -2 -5 3 L-1 1 M1 0 L5 -2.5 Q6 -2 5 3 L1 1"
            fill="#ce637c"
          />
          <path
            d="M-4 0 L0 1 L4 0"
    ...
    case "earrings":
      shape = (
        <g stroke="#be9036" fill="none" strokeWidth="1.2">
