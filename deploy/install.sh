...
report() {
  ...
  log "signs you in as \"$RESOLVED_OWNER_NAME\". It is also saved on this"
  log "server at $INVITE_FILE. To mint a fresh one, re-run this installer."
  log ""
  log "HTTPS needs the DNS A record for $DOMAIN to point at this server;"
