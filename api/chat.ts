...
- Isomux masks recognized secret patterns in new agent and scheduled-run log entries before storage. Existing logs and backend-owned transcripts stay unchanged. Unmatched secrets can still be stored.
