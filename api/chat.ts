...
- Isomux-bundled skills like /isomux-peer-review (one agent reviews another's ongoing work and messages feedback directly to them), /isomux-pair-programming (drive a feature end-to-end with another agent reviewing design and code), /isomux-grill-me (stress-tests a feature design; based on the original /grill-me by Matt Pocock), /isomux-subagent-review (spawn a subagent to review uncommitted diff before commit), /isomux-report-bug
