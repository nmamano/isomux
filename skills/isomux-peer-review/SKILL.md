...
2. If a name was provided in the user context, find that agent. Otherwise list candidates (everyone with an active `topic`, excluding yourself; prefer agents whose `cwd` matches yours) and ask the boss to pick.
