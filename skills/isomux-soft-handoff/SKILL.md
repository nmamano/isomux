...
POST the brief to `localhost:4000/agents/<peer-id>/message` with your own `senderAgentId` so the peer knows who's handing off. The body MUST also tell the peer:
