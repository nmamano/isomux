...
export const es: Catalog = {
  ...
  "apiCall.agents.browser": "Usar una página en el navegador",
  "apiCall.agents.browserDetail": "Usar una página en el navegador",
  ...
  "panels.browser.waiting": "Esperando a que el agente abra una página",
