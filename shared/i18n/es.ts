...
export const es: Catalog = {
  ...
  "browser.intro": "Los agentes pueden navegar, leer páginas y rellenar formularios. Elige el navegador del servidor o conecta Chrome de tu ordenador para usar tus sesiones abiertas. Cada agente controla su propia pestaña.",
  "browser.backend": "Navegador",
  "browser.chromeHelp": "Los agentes usan Chrome en este ordenador. Instala y vincula la extensión abajo.",
  "browser.serverHelp": "Los agentes usan Chrome en el servidor de la oficina. No hace falta una extensión.",
  ...
  "browser.unknown":
    "Resultado de desvinculación desconocido. Comprueba los ajustes de la oficina.",
  "browser.download": "Descargar extensión {version}",
  "browser.install":
    "Extrae el ZIP. En Chrome de escritorio, abre chrome://extensions, activa el modo de desarrollador, selecciona Cargar descomprimida y elige la carpeta extraída. Fija Isomux Browser en la barra de herramientas.",
  "browser.permission":
  ...
  "browser.pairHelp":
    "Abre Isomux Browser e introduce la dirección de esta oficina y el código de vinculación.",
  ...
  "browser.failed":
    "La solicitud al navegador ha fallado. Comprueba la conexión e inténtalo de nuevo.",
