...
export const ca: Catalog = {
  ...
  "browser.intro": "Els agents poden navegar, llegir pàgines i omplir formularis. Tria el navegador del servidor o connecta Chrome del teu ordinador per utilitzar les sessions obertes. Cada agent controla la seva pestanya.",
  ...
  "browser.serverHelp": "Els agents utilitzen Chrome al servidor de l’oficina. No cal cap extensió.",
  ...
  "browser.disconnect": "Desconnecta",
...
- Crear una App d'itinerari personalitzada i registrar-la a Isomux perquè la tingui al telèfon durant el viatge. Si vol, pot convidar els seus companys de viatge a la seva oficina d'Isomux perquè també vegin l'App de l'itinerari, o fins i tot et facin preguntes directament. Però ha de saber que els seus companys de viatge podrien obtenir accés a altres agents de les sales que puguin veure (i accés per terminal a tot el sistema de fitxers).`,
  ...
  "membersChat.thumbsUp": "M’agrada",
  "membersChat.removeThumbsUp": "Treu m’agrada",
  "membersChat.reactors": "M’agrada: {count}",
  "membersChat.reactionFailed": "No s’ha pogut actualitzar la reacció",
  "apiCall.membersChat.thumbsUp": "Marca m’agrada al xat de membres",
  "membersChat.resize": "Canvia l’amplada del xat",
  ...
  "membersChat.pinFailed": "No s’ha pogut actualitzar el missatge fixat",
  "apiCall.membersChat.pin": "Fixa un missatge del xat de membres",
  ...
  "nav.tasksShortcut": "Tasques (t)",
  "nav.appsShortcut": "Apps (a)",
  "nav.settingsShortcut": "Configuració (s)",
  "common.moreActions": "Més accions",
  ...
  "settings.externalAccess.managed":
    "Hosted Isomux gestiona l'adreça d'aquesta oficina; no es pot canviar.",
  ...
  "dialogs.agent.costume": "Disfressa",
  "dialogs.agent.costume.none": "Cap",
  "dialogs.agent.costume.doctor": "Metge",
  "dialogs.agent.costume.police": "Policia",
  "dialogs.agent.costume.firefighter": "Bomber",
  "dialogs.agent.costume.chef": "Xef",
  "dialogs.agent.costume.construction": "Treballador de la construcció",
  ...
  "dialogs.agent.managerHint":
    "L’agent fa servir les connexions a proveïdors i les variables personals d’aquest membre. Consulta Configuració → Tu → Connexions individuals.",
  ...
  "dialogs.agent.spawnPreviewHint":
    "L’ID de l’agent s’assignarà en crear-lo. Aquesta previsualització fa servir «new-agent».",
  "dialogs.agent.cwdHint":
    "La carpeta on l’agent comença a treballar. L’agent també pot accedir a fitxers fora d’aquesta carpeta.",
  ...
  "apiCall.inbox.messageBoss": "Missatge enviat al token extern",
  ...
  "apiCall.rooms.setSkin": "Posar l'aspecte d'una sala",
  ...
  "logView.queue.flushHint":
    "Envia ara els missatges en cua - interromp el torn actual (Ctrl+Enter)",
  ...
  "logView.nav.browserTitle": "Obre el navegador en directe",
  "logView.nav.terminalTitle": "Obre la terminal (Ctrl+`)",
  "logView.nav.endConversation": "Finalitza",
  "logView.nav.endConversationTitle":
    "Finalitza la conversa. La pots reprendre més tard amb /resume.",
  "logView.backToOffice": "← Torna a l'oficina",
  "logView.backToOfficeTitle": "Torna a l'oficina (Esc)",
  ...
  "panels.browser.endPage": "Tanca la pàgina",
  "panels.browser.back": "Enrere",
  "panels.browser.forward": "Endavant",
  "panels.browser.reload": "Recarrega",
  "panels.browser.address": "Adreça",
  "panels.browser.copySelection": "Copia la selecció",
  ...
  "office.zoom.inShortcut": "Apropa (+)",
  "office.zoom.out": "Allunya",
  "office.zoom.outShortcut": "Allunya (-)",
  "office.zoom.reset": "Restableix la vista (0)",
  "office.zoom.resetAria": "Restableix la vista",
  "office.openWebsite": "Obre isomux.com",
  "office.skin.label": "Aspecte de la sala",
