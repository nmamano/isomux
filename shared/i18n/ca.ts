...
export const ca: Catalog = {
  ...
  "apiCall.agents.browser": "Utilitzar una pàgina al navegador",
  "apiCall.agents.browserDetail": "Utilitzar una pàgina al navegador",
  ...
  "panels.browser.waiting": "Esperant que l’agent obri una pàgina",
