...
export const en = {
  ...
  "browser.intro": "Let agents browse, read pages, and fill forms. Choose the server browser or connect your desktop Chrome, where agents can use your existing logins. Each agent controls its own tab.",
  "browser.backend": "Browser",
  "browser.chromeHelp": "Agents use Chrome on this computer. Install and pair the extension below.",
  "browser.serverHelp": "Agents use Chrome on the office server. No extension is needed.",
  ...
  "browser.disabled": "Disconnected by member",
...
Never ask for or repeat secrets (API keys, tokens, passwords). Point people to Settings → You → Individual connections.`,
  ...
  "panels.browser.copySelection": "Copy selection",
  "panels.browser.copied": "Copied.",
