...
export const en = {
  ...
  "apiCall.agents.browser": "Use a page in the browser",
  "apiCall.agents.browserDetail": "Use a page in the browser",
  ...
  "panels.browser.waiting": "Waiting for the agent to open a page",
