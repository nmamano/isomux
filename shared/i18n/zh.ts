...
export const zh: Catalog = {
  ...
  "browser.revoking": "正在关闭 {name} 的控制…",
  "browser.tabIneligible": "打开 HTTP(S) 标签页以允许代理控制。",
  "browser.tabConflict": "此代理已有标签页。请先关闭该标签页的控制。",
  "browser.tabOff": "OFF · 选择代理并开启“允许代理控制”。",
  "browser.control": "代理控制",
  "browser.title": "浏览器使用",
  "browser.intro": "让智能体浏览、阅读网页和填写表单。选择服务器浏览器，或连接桌面 Chrome 以使用现有登录。每个智能体控制自己的标签页。",
  "browser.backend": "浏览器",
  "browser.chromeHelp": "智能体使用此电脑上的 Chrome。请在下方安装并配对扩展。",
  "browser.serverHelp": "智能体使用办公室服务器上的 Chrome，无需扩展。",
  ...
  "browser.server": "服务器浏览器",
  "browser.chrome": "桌面 Chrome",
  "browser.ownership": "代理使用其管理者的浏览器。每个代理控制自己的标签页。",
  "browser.paired": "已配对",
  "browser.unpaired": "未配对",
  "browser.offline": "离线",
  "browser.connecting": "正在连接…",
  "browser.connected": "已连接",
  "browser.disabled": "成员已断开连接",
  ...
  "browser.copy": "复制配对码",
  "browser.copied": "已复制",
  "browser.pairHelp": "打开 Isomux Browser，输入此办公室地址和配对码。",
  "browser.office": "办公室地址",
  "browser.pair": "配对 Chrome",
