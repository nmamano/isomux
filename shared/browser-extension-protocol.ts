...
export function fields(value: unknown): Fields {
  if (!value || typeof value !== "object" || Array.isArray(value)) throw new Error("Invalid browser message");
...
const PAGE_COMMANDS = new Set([
  ...
  "Page.createIsolatedWorld", "Page.navigate", "Page.reload", "Page.getNavigationHistory",
  "Page.navigateToHistoryEntry", "Page.captureScreenshot", "Page.getLayoutMetrics",
  "Page.handleJavaScriptDialog", "Page.setInterceptFileChooserDialog", "Page.bringToFront",
  "Runtime.enable", "Runtime.evaluate", "Runtime.callFunctionOn", "Runtime.getProperties",
  "Runtime.releaseObject", "Runtime.releaseObjectGroup", "Runtime.runIfWaitingForDebugger",
  "Runtime.addBinding", "Runtime.removeBinding",
  "DOM.enable", "DOM.getDocument", "DOM.describeNode", "DOM.resolveNode",
  "DOM.getContentQuads", "DOM.getBoxModel", "DOM.scrollIntoViewIfNeeded",
  "DOM.setFileInputFiles", "DOM.getNodeForLocation", "DOM.focus",
  "Log.enable", "Network.enable", "Network.getResponseBody",
  "Input.dispatchMouseEvent", "Input.dispatchKeyEvent", "Input.insertText",
  "Input.dispatchTouchEvent", "Input.synthesizeScrollGesture",
...
export function pageCommandAllowed(method: string, params: Fields): boolean {
  return PAGE_COMMANDS.has(method) && !("targetId" in params) && !("browserContextId" in params);
}
